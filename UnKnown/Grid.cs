...
public enum Scenario {Known, Unknown};
...
public class Grid : MonoBehaviour {
	...
	public Node FromXY(int x, int y){
		return grid[x,y];
	}

	public void DiscoverNodes(Vector3 pos){
		List<Node> neighbours = GetNeighbours(NodeFromWorldPoint(pos));
		foreach(Node n in neighbours){
			DiscoverNode(n.gridX,n.gridY);
		}
	}

	void DiscoverNode(int x, int y){
